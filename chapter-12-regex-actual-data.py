# Instructions
    ...
    # Data Files
        ...
        # Actual data: http://py4e-data.dr-chuck.net/regex_sum_610952.txt (There are 81 values and the sum ends with 907)
...
with open('py4e-data.dr-chuck.net-regex_sum_610952.txt', 'r') as fo:
    for line in fo:
